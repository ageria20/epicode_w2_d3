...
for (let i = 0; i < starWarsCharacters.length; i++) {
  // console.log("Il valore è:", starWarsCharacters[i].name);
...
for (let index = 0; index < starWarsCharacters.length; index++) {
  // console.log(starWarsCharacters[index].eye_color);
...
let randomElement = Math.round(Math.random(starWarsCharacters.length));
console.log(
  "Ciao a tutti sono ",
  starWarsCharacters[randomElement].name,
  ", sono alto",
  starWarsCharacters[randomElement].height,
  "occupo uno spazio nell'universo di",
  starWarsCharacters[randomElement].mass,
  ", ho i capelli di colore",
  starWarsCharacters[randomElement].hair_color,
  ", il mio livello di abbronzatura è",
  starWarsCharacters[randomElement].skin_color,
  "ho gli occhi di colore",
  starWarsCharacters[randomElement].eye_color,
  ", sono nato nel",
  starWarsCharacters[randomElement].birth_year,
  "sono un",
  starWarsCharacters[randomElement].gender
);
